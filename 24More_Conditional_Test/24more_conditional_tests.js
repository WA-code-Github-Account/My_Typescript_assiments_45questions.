...
//Inequality test
console.log("Inequality test with strings:", "Apple" !== "orange"); //true
...
console.log("Lowercase function test:", "WHATSAPP" === "whatsapp"); //false
// Numerical tests involving equality 
console.log("Equality test with numbers:", 7 === 7); //true
console.log("Equality test with numbers:", 7 !== 7); //false
// Numerical tests involving inequality 
console.log("Inequality test with numbers:", 5 !== 6); //true
console.log("Inequality test with numbers:", 5 === 6); //false
//greater than test 
